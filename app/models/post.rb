class Post < ApplicationRecord
    #post's title can't be empty/falsy
...
#     # add a custom validator that ensures the title is clickbait-y, should add a validation error if the title does not contain:
